...
export default function ContratosPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payload = {
        ID_EMPRESA: isEditing ? currentContrato?.ID_EMPRESA : undefined,
        EMPRESA: formData.EMPRESA,
        CNPJ: formData.CNPJ,
        SANKHYA_TOKEN: formData.SANKHYA_TOKEN,
        SANKHYA_APPKEY: formData.SANKHYA_APPKEY,
        SANKHYA_USERNAME: formData.SANKHYA_USERNAME,
        SANKHYA_PASSWORD: formData.SANKHYA_PASSWORD,
        GEMINI_API_KEY: formData.GEMINI_API_KEY,
        ATIVO: formData.ATIVO,
        IS_SANDBOX: formData.IS_SANDBOX // Included IS_SANDBOX in the payload
      }
                ...
                {contratos.map((contrato) => (
                  <TableRow key={contrato.ID_EMPRESA}>
                    ...
                    <TableCell> {/* Cell for Sandbox status */}
                      <Badge variant={contrato.IS_SANDBOX ? "default" : "outline"}>
